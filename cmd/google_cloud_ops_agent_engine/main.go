...
import (
	...
	"github.com/GoogleCloudPlatform/ops-agent/constants"
)
...
func run() error {
	...
	if err := confgenerator.SetMetricsPrefix(*etcDir, confDebugFolder, constants.MetricsPrefixInputFile, constants.MetricsPrefixOutputFile); err != nil {
		return err
	}
